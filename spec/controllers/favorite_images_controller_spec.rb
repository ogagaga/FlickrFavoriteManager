  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested favorite_image" do
        ...
        FavoriteImage.any_instance.should_receive(:update).with({ "title" => "TitleChangeString" })
        put :update, {:id => favorite_image.to_param, :favorite_image => { "title" => "TitleChangeString" }}, valid_session
      end
